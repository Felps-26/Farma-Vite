...
2) Usando Python (recomendado quando não há Node instalado)
...
Observação: alguns arquivos usam caminhos absolutos iniciando com `/pages/...` ou `/js/...`. Se o servidor for servido a partir da raiz do repositório, esses caminhos funcionarão corretamente.
